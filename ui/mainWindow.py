...
##        assert(sz_freq_list == sz_ampl_list)
    ...
    def set_steps(self):
        ...
        Fix the list of sweep frequencies:

            This is a list of numpy.float's generated by numpy.arange().
            But we want to include the stop-value as the last entry in the
            list which the arange() function doesn't do. Because the stop
            value isn't included we can test for and append the final value.
        """
        MHz = 1000
