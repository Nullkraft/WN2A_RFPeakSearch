...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addItem(spacerItem5, 14, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.chkShowGrid, 13, 0, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.cboxSerialPorts = QtWidgets.QComboBox(self.groupBox_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.cboxSerialPorts.sizePolicy().hasHeightForWidth())
        self.cboxSerialPorts.setSizePolicy(sizePolicy)
        self.cboxSerialPorts.setSizeAdjustPolicy(QtWidgets.QComboBox.AdjustToContents)
        self.cboxSerialPorts.setObjectName("cboxSerialPorts")
        self.horizontalLayout_2.addWidget(self.cboxSerialPorts)
        spacerItem10 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem10)
        self.label_5 = QtWidgets.QLabel(self.groupBox_4)
        self.label_5.setObjectName("label_5")
        self.horizontalLayout_2.addWidget(self.label_5)
        self.numDelayMilliseconds = QtWidgets.QSpinBox(self.groupBox_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.numDelayMilliseconds.sizePolicy().hasHeightForWidth())
        self.numDelayMilliseconds.setSizePolicy(sizePolicy)
        self.numDelayMilliseconds.setObjectName("numDelayMilliseconds")
        self.horizontalLayout_2.addWidget(self.numDelayMilliseconds)
        ...
        self.label_5.setBuddy(self.numDelayMilliseconds)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cboxSerialPorts.setToolTip(_translate("MainWindow", "List of all serial ports"))
        self.cboxSerialPorts.setWhatsThis(_translate("MainWindow", "List of all serial ports"))
        self.cboxSerialPorts.setAccessibleName(_translate("MainWindow", "List of all serial ports"))
        self.label_5.setText(_translate("MainWindow", "Trasmission Delay (ms)"))
        ...
        self.checkBox.setText(_translate("MainWindow", "Lock Detect"))
        self.checkBox_2.setText(_translate("MainWindow", "Fractional Optimization"))
