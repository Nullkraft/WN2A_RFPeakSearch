...
BW=Fmax-Fmin 
points=(int(BW/StepSize)) + 1

maxErr=0
Tstart=timer

open filename for Output as #7
print #7, " Fvco", "minErr", "Fpfd", "F", "M", "N", "Calculated-Fvco"
...
for x=0 to points
  ...
  ' Write results of F, M and N calculations to file
  print #7, Fvco, minErr, Fpfd, BestF, BestM, N, (Fpfd * (BestF / BestM + N))
