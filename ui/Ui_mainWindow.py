...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.floatSweepStartFreq = QtWidgets.QDoubleSpinBox(parent=self.groupBox)
        ...
        self.floatSweepStopFreq = QtWidgets.QDoubleSpinBox(parent=self.groupBox)
        ...
        self.label_graphWidth = QtWidgets.QLabel(parent=self.groupBox)
        self.label_graphWidth.setObjectName("label_graphWidth")
        self.verticalLayout.addWidget(self.label_graphWidth)
        self.minGraphWidth = QtWidgets.QSpinBox(parent=self.groupBox)
        ...
        self.label_graphHeight = QtWidgets.QLabel(parent=self.groupBox)
        self.label_graphHeight.setObjectName("label_graphHeight")
        self.verticalLayout.addWidget(self.label_graphHeight)
        self.minGraphHeight = QtWidgets.QSpinBox(parent=self.groupBox)
        ...
        self.chkArduinoLED = QtWidgets.QCheckBox(parent=self.groupBox_3)
        ...
        self.numPlotFloor = QtWidgets.QDoubleSpinBox(parent=self.groupBox_3)
        ...
        self.numPlotCeiling = QtWidgets.QDoubleSpinBox(parent=self.groupBox_3)
        ...
        self.cbxSerialPortSelection = QtWidgets.QComboBox(parent=self.groupBox_3)
        ...
        self.btnRefreshPortsList = QtWidgets.QPushButton(parent=self.groupBox_3)
        self.btnRefreshPortsList.setObjectName("btnRefreshPortsList")
        self.gridLayout_2.addWidget(self.btnRefreshPortsList, 18, 0, 1, 1)
        self.numPeakMarkers = QtWidgets.QSpinBox(parent=self.groupBox_3)
        ...
        self.cbxSerialSpeedSelection = QtWidgets.QComboBox(parent=self.groupBox_3)
        ...
        self.chkShowGrid = QtWidgets.QCheckBox(parent=self.groupBox_3)
        ...
        self.dbl_attenuator_dB = QtWidgets.QDoubleSpinBox(parent=self.groupBox_3)
        ...
        self.btn_open_serial_port = QtWidgets.QPushButton(parent=self.groupBox_3)
        ...
        self.btnClearPeakSearch = QtWidgets.QPushButton(parent=self.groupBox_3)
        self.btnClearPeakSearch.setObjectName("btnClearPeakSearch")
        self.gridLayout_2.addWidget(self.btnClearPeakSearch, 2, 0, 1, 1)
        self.btnPeakSearch = QtWidgets.QPushButton(parent=self.groupBox_3)
        ...
        self.dblCenterMHz = QtWidgets.QDoubleSpinBox(parent=self.groupBox_2)
        ...
        self.gridLayout_3.addWidget(self.dblCenterMHz, 8, 1, 1, 1)
        self.dblSpanMHz = QtWidgets.QDoubleSpinBox(parent=self.groupBox_2)
        ...
        self.gridLayout_3.addWidget(self.dblSpanMHz, 8, 3, 1, 1)
        spacerItem5 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout_3.addItem(spacerItem5, 5, 7, 1, 1)
        self.floatStartMHz = QtWidgets.QDoubleSpinBox(parent=self.groupBox_2)
        ...
        self.gridLayout_3.addWidget(self.floatStartMHz, 5, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.label, 6, 3, 1, 1)
        self.label_1 = QtWidgets.QLabel(parent=self.groupBox_2)
        self.label_1.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.label_1.setObjectName("label_1")
        self.gridLayout_3.addWidget(self.label_1, 2, 1, 1, 1)
        ...
        self.gridLayout_3.addItem(spacerItem7, 5, 4, 1, 1)
        self.floatStopMHz = QtWidgets.QDoubleSpinBox(parent=self.groupBox_2)
        ...
        self.gridLayout_3.addWidget(self.numFrequencySteps, 8, 5, 1, 1)
        self.label_10 = QtWidgets.QLabel(parent=self.groupBox_2)
        self.label_10.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.label_10.setObjectName("label_10")
        self.gridLayout_3.addWidget(self.label_10, 6, 5, 1, 1)
        self.intStepKHz = QtWidgets.QSpinBox(parent=self.groupBox_2)
        ...
        self.gridLayout_3.addWidget(self.intStepKHz, 5, 5, 1, 1)
        ...
        self.btnCalibrate = QtWidgets.QPushButton(parent=self.groupBox_4)
        self.btnCalibrate.setObjectName("btnCalibrate")
        self.horizontalLayout_2.addWidget(self.btnCalibrate)
        self.btn_make_control_dict = QtWidgets.QPushButton(parent=self.groupBox_4)
        ...
        self.selectReferenceOscillator = QtWidgets.QComboBox(parent=self.groupBox_4)
        ...
        self.chk_plot_enable = QtWidgets.QCheckBox(parent=self.groupBox_4)
        ...
        self.selectSweepFrequency = QtWidgets.QRadioButton(parent=self.groupBox_4)
        ...
        self.selectFixedFrequency = QtWidgets.QRadioButton(parent=self.groupBox_4)
        ...
        self.btnTrigger = QtWidgets.QPushButton(parent=self.groupBox_5)
        ...
        self.btnExit = QtWidgets.QPushButton(parent=self.groupBox_5)
        ...
        self.btn_get_arduino_msg = QtWidgets.QPushButton(parent=self.groupBox_6)
        self.btn_get_arduino_msg.setObjectName("btn_get_arduino_msg")
        self.verticalLayout_3.addWidget(self.btn_get_arduino_msg)
        self.btnSweep = QtWidgets.QPushButton(parent=self.groupBox_6)
        self.btnSweep.setObjectName("btnSweep")
        self.verticalLayout_3.addWidget(self.btnSweep)
        self.chkContinuousSweep = QtWidgets.QCheckBox(parent=self.groupBox_6)
        self.chkContinuousSweep.setObjectName("chkContinuousSweep")
        self.verticalLayout_3.addWidget(self.chkContinuousSweep)
        self.label_sweep_status = QtWidgets.QLabel(parent=self.groupBox_6)
        ...
        self.line_edit_cmd = QtWidgets.QLineEdit(parent=self.groupBox_6)
        ...
        MainWindow.setTabOrder(self.intStepKHz, self.numFrequencySteps)
        MainWindow.setTabOrder(self.numFrequencySteps, self.minGraphHeight)
        ...
        MainWindow.setTabOrder(self.dblCenterMHz, self.btnCalibrate)
        ...
        MainWindow.setTabOrder(self.line_edit_cmd, self.btnSweep)
        MainWindow.setTabOrder(self.btnSweep, self.minGraphWidth)
        MainWindow.setTabOrder(self.minGraphWidth, self.btn_make_control_dict)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.chkContinuousSweep.setText(_translate("MainWindow", "Continuous Sweep"))
