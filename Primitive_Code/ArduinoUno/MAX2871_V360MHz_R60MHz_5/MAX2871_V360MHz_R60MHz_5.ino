...
//************************************************//
//  Name    : MAX2871_V360MHz_R60MHz_5.ino        //
//  Author  : WN2A                                //
//  Date    : 16 June 2020                          //
//  Version : 1.0  See MAX2871_Alpha_Code_ReadMe.txt             //
//  Notes   : Alpha Code for using MAX2871 VCO=360/187.5MHz REF=60MHz PFD=15 MHz //
//************************************************//
...
//            R0   R1   R2   R3   R4   R5  //
//int Byte0[]={0x00,0x61,0x42,0x03,0xFC,0x05}; //360 MHz
//int Byte1[]={0x00,0x00,0x12,0x00,0xF1,0x00};
//int Byte2[]={0xC0,0x40,0x01,0x08,0xCF,0x40};
...
//int Byte10[]={0xD8,0x61,0x42,0x03,0xFC,0x05}; //282.109375 MHz
//int Byte11[]={0x25,0x00,0x12,0x00,0xF1,0x00};
//int Byte12[]={0x64,0x40,0x01,0x08,0xCF,0x40};
//int Byte13[]={0x00,0x00,0x34,0xF8,0x63,0x80};
...
void setup() {
  ...
  Serial.begin(9600);
  Serial.println ("MAX2871_V360MHz_R60MHz_5.ino ");
  Serial.println("Code for using MAX2871 Synthesizer Vco=360MHz Ref=60 MHz PFD=15MHz (6 Registers)");
  Serial.println("This version supports Lock Detect signal, 360/187.5/360 and more");
...
void loop() {
  int x=0 ;
CmdFreq:
 //   if (y == 0) {  //Do this if initial CmdFreq
   // digitalWrite(13,HIGH); //Initially LED ON
   //  LD= digitalRead(3);
   
 //    if (LD ==  LOW) {
//     delay(1);  
  //   digitalWrite (13, LOW); //LED OFF IF no LD
 // int x;
 // delay(1);
    // digitalWrite (strobe, LOW);
    //  digitalWrite (strobe, HIGH);
