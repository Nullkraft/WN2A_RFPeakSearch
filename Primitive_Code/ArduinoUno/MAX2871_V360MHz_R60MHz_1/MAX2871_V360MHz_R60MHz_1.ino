...
//************************************************//
//  Name    : MAX2871_V360MHz_R60MHz_1.ino        //
//  Author  : WN2A                                //
//  Date    : 4 May 2020                          //
//  Version : 1.0  See MAX2871_Alpha_Code_ReadMe.txt             //
//  Notes   : Alpha Code for using MAX2871 VCO=360MHz REF=60MHz  //
//************************************************//
...
int Byte1[]={0x80,0x00,0x12,0x00,0xF1,0x00};
int Byte2[]={0x66,0x40,0x01,0x01,0xBF,0x40};
...
void setup() {
  ...
  Serial.begin(9600);
  Serial.println ("MAX2871_V360MHz_R60MHz_1.ino ");
  Serial.println("Code for using MAX2871 Synthesizer Vco=360MHz Ref=60 MHz (7 Registers)");
}
