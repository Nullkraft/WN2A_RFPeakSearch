...
Setup:
screen 17 :cls
print "ADF4356_2_Sweep.bas for Spectrum Analyzer Freq Synthesizer LO#1 3499-6500 MHz"
...
Flag=0
input "Enter Fstart [MHz] ";Fstart
input "Enter Fstop [MHz] ";Fstop
input "Enter Finc [MHz] ";Finc
do
LoopBack:
...
print "For ADF4356 Fout=53.125-6800 MHz with Arduino ShiftOut_Word_7.ino" 
print "Refer to README_ADF4356_2.txt":print
Print "Current Fpfd= ";Fpfd;" [MHz]   Fchsp= ";Fchsp;" [kHz]   Press  q to Quit"
